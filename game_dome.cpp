...
public:
    ...
    void play_instructions()
    {
        ...
        {
            cout << "\r" << setw(106) << "Enter your choice: ";
            cin >> choose;
            choose = toupper(choose);
        ...
        {
            read_file();
            cout << setw(40) << "Press Enter To Start the Game.... ";
            cin.get();
            cin.ignore();
            system("cls");
        }
...
void save_record(up7down7 g2, r_p_s g3)
{
    ...
    ofstream os;
    os.open("record.txt", ios_base::app);
    if (transfer == false)
    {
        up_down_rounds++;
...
public:
    ...
    void games_menu()
    {
        ...
        back:
            ...
            get_path("record.txt");
            read_file();
            cout << setw(40) << "Press Enter To Go Back To Menu.... ";
            cin.get();
            system("cls");
            break;
            case '6':
